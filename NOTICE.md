...
TokenSquash is source-available software, not open-source software.

Required Notice: Copyright (c) 2026 TWO HANDS NETWORK LTD.

TokenSquash is licensed under the PolyForm Noncommercial License 1.0.0. Personal, hobby, research, educational, public-interest, and other non-commercial uses are permitted under that license.

Commercial use requires a separate written license from the licensor. Commercial use includes, without limitation:

- bundling TokenSquash or derived code into a paid product;
- offering TokenSquash functionality through a hosted, managed, SaaS, cloud, API, or agent service;
- using TokenSquash in an enterprise product or commercial developer tool;
- using TokenSquash or derived code as part of a commercial AI coding, agent, memory, context, retrieval, or repository-analysis product;
