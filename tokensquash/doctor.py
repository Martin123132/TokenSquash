...
def _check_product_manifest(cwd: Path) -> dict[str, Any]:
    ...
    required_schemas = {
        ...
        "tokensquash.github_release.verify.v1",
        ...
        "tokensquash.turns.first_run.v1",
...
def _check_governance_documents(cwd: Path) -> dict[str, Any]:
    ...
    required_references = {
        "README.md": [
            ...
            "docs/first-real-corpus.md",
            "docs/sidecar-ollama.md",
            "docs/sidecar-meaning-rubric.md",
        ...
        "docs/quickstart.md": [
            ...
            "python -m tokensquash readiness",
            "private-turns/",
        ],
        "docs/command-map.md": [
            "Command Map",
            ...
            "turns claim-pack",
            "sidecar roundtrip",
            "release-candidate --require-clean",
        ...
        "docs/release-notes-v0.1.1.md": [
            ...
            "public-polish and release-evidence patch",
            "does not change the deterministic `ts1` prompt protocol or `tr1` reply protocol",
            "release-assets --update-verification-doc",
            "Evidence Contract",
            "release-candidate --require-clean",
            "verify-release-candidate --require-release-candidate-pass",
            "docs/release-verification.md",
            PUBLIC_LICENSE_NAME,
            LICENSOR,
        ],
        ...
        "docs/release-notes-v0.2.2.md": [
            ...
            "public download verifier status",
            PUBLIC_LICENSE_NAME,
            LICENSOR,
        ],
        "docs/release-verification.md": [
        ...
        "docs/v0.1.1-plan.md": [
            ...
            "Sidecar Evidence",
            "quickstart.md",
            "real-turn-workflow.md",
            "evidence-packs.md",
            "release-candidate.md",
            "sidecar-ollama.md",
            "commercial-license.md",
            "post-release-flow.md",
            "first-real-corpus.md",
            "sidecar-meaning-rubric.md",
        ...
        "docs/v0.3.0-plan.md": [
            ...
            "verify-release-assets",
            "verify-github-release",
            "deterministic codec remains the source of truth",
            "Out Of Scope",
        ],
