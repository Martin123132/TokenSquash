...
READINESS_COMMANDS = [
    ...
    "python -m tokensquash release-assets private-turns\\release-candidate --tag v0.2.0 --update-verification-doc docs\\release-verification.md",
...
GOVERNANCE_DOCUMENTS = [
    ...
    {"path": "docs/release-notes-v0.2.0.md", "purpose": "Draft v0.2.0 release bar, required assets, and final evidence fields."},
