...
SUPPORTED_SCHEMAS = [
    ...
    ("product", "tokensquash.guide.v1", "Beginner-friendly command path guide."),
    ...
    ("product", "tokensquash.github_release.verify.v1", "Downloaded GitHub Release asset and wheel-smoke verification report."),
    ...
    ("turns", "tokensquash.turns.first_run.v1", "Beginner-friendly first real turn capture and scorecard report."),
...
READINESS_COMMANDS = [
    ...
    "python -m tokensquash release-assets private-turns\\release-candidate --tag v0.2.2 --update-verification-doc docs\\release-verification.md",
...
GOVERNANCE_DOCUMENTS = [
    ...
    {"path": "docs/command-map.md", "purpose": "Beginner command chooser for common TokenSquash jobs."},
    ...
    {"path": "docs/release-notes-v0.2.0.md", "purpose": "Published v0.2.0 release bar, required assets, and final evidence fields."},
    {"path": "docs/release-notes-v0.2.1.md", "purpose": "v0.2.1 claim-pack polish scope, required assets, and release-candidate bar."},
    {"path": "docs/release-notes-v0.2.2.md", "purpose": "v0.2.2 usability, licensing, notice, and package-evidence polish release notes."},
